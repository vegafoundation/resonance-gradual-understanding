...
This repository contains the conceptual definition and theoretical framework for **Gradual Understanding**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── gradual-understanding.tex    # LaTeX dissertation
├── whitepaper/
│   └── gradual-understanding.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025gradualunderstanding,
  author = {Vega, Adam Eren},
  title = {Gradual Understanding: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/gradual-understanding}
}
```
